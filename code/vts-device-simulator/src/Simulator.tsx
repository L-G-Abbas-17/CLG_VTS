...
export default function Simulator() {
  ...
  const loadPublisherHealth = useCallback(async () => {
    try {
  ...
  useEffect(() => {
    loadDevices();
    void loadPublisherHealth();
    return () => {
      if (timerRef.current) {
        window.clearInterval(timerRef.current);
      }
    };
  }, [loadDevices, loadPublisherHealth]);
        ...
        <div className="sim-setup grid gap-6">
          <div className="glass card-glow rounded-2xl p-5">
            ...
            <p className="text-sm text-[var(--muted)]">
              ...
              {' '}loads devices from your DB and sends the UI-generated telemetry directly over MQTT,
              {' '}TCP, or UDP.
            </p>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="flex flex-col gap-2 md:col-span-2">
                  <div className="flex flex-wrap items-center gap-2 text-xs text-[var(--muted)]">
                    <span>Devices come from the real DB inside `vts-device-simulator`.</span>
                    <button
                ...
                <div className="flex flex-col gap-2 md:col-span-2">
                  <label className="text-xs uppercase tracking-[0.2em] text-[var(--muted)]">Direct Publish Path</label>
                  <div className="rounded-xl border border-white/10 bg-[var(--panel)]/60 px-3 py-2 text-sm text-white">
                    <p className="truncate">Service: {deviceSimulatorUrl}</p>
          ...
          <div className="sim-game__grid">
            ...
            <div className="sim-game__hud">
              ...
              <div className="sim-hud-card">
                ...
                <p className="sim-hud-sub">Service: {deviceSimulatorUrl}</p>
              </div>
              <div className="sim-hud-card">
